...
interface GSAC {
   ...
   */
  approve: ({ from, spender, amount, expiration_ledger }: { from: string, spender: string, amount: contract.i128, expiration_ledger: contract.u32 }, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * i128`
   */
  burn: ({ from, amount }: { from: string, amount: contract.i128 }, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * i128`
   */
  burn_from: ({ spender, from, amount }: { spender: string, from: string, amount: contract.i128 }, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * data = amount: i128`
   */
  clawback: ({ from, amount }: { from: string, amount: contract.i128 }, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * = amount: i128`
   */
  mint: ({ to, amount }: { to: string, amount: contract.i128 }, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * data = amount: i128`
   */
  transfer: ({ from, to, amount }: { from: string, to: string, amount: contract.i128 }, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
   ...
   * data = amount: i128`
   */
  transfer_from: ({ spender, from, to, amount }: { spender: string, from: string, to: string, amount: contract.i128 }, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
class GSAC extends contract.Client {
  static async deploy<T = GSAC>(
  ...
  constructor(public readonly options: contract.ClientOptions) {
    super(
      new contract.Spec(["",
  ...
  public readonly fromJSON = {
    allowance: this.txFromJSON<contract.i128>,
    authorized: this.txFromJSON<boolean>,
    approve: this.txFromJSON<null>,
    balance: this.txFromJSON<contract.i128>,
    burn: this.txFromJSON<null>,
    burn_from: this.txFromJSON<null>,
    clawback: this.txFromJSON<null>,
    decimals: this.txFromJSON<contract.u32>,
...
export class SAC {
  ...
  public getSACClient(SACContractId: string, publicKey: string) {
    return new GSAC({
